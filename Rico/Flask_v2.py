...
function init3D() {
    ...
    scene.background = new THREE.Color(0x000000);  // Black so white model shows clearly
    ...
    loader.load("/static/models/DJI_mavic_air_drone.glb", function(gltf) {
        ...
        // Force WHITE material so model is visible
...
function updateDronePosition(altitude) {
    ...
    droneModel.position.y += (yPos - droneModel.position.y) * 0.15;
}
</script>
...
<div class="container">
  ...
  <form id="simulationForm">
    ...
    <input type="number" id="sim_altitude" step="0.1"><br><br>

    <label>Speed (m/s):</label><br>
    <input type="number" id="sim_speed" step="0.1"><br><br>

    <label>Latitude:</label><br>
    <input type="text" id="sim_lat"><br><br>

    <label>Longitude:</label><br>
    <input type="text" id="sim_lon"><br><br>
...
<div class="container">
  ...
  <div class="value-box">Altitude: <span id="altitude">0</span> m</div>
  <div class="value-box">Speed: <span id="speed">0</span> m/s</div>
